...
public final class Constants {
  public static final class CanIds {
    ...
    // Lift
    public static final class LiftCanIds {
  ...
  public static final class DriveConstants {
    ...
    // Outer perimeter 28" x 28" with corner-flush MAXSwerve mounting and 1.75" inward wheel center offset
    // Resulting wheelbase/trackwidth (converted): 0.6223 m
...
//    public static final double kWheelBase = Units.inchesToMeters(26.5);
    ...
    // CAN ID for a CTRE Pigeon IMU (assumed 1 — change to your Pigeon's CAN ID)
    public static final int kPigeonCanId = 24;
  }
  ...
  public static final class ShooterConstants {
    ...
    public static final double kShooterTargetRPM = 6000.0;
    // Min/max for variable shooter RPM
    public static final double kShooterMinRPM = 3000.0;
    public static final double kShooterMaxRPM = 6200.0;
